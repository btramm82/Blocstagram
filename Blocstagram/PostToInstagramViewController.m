...
- (instancetype)initWithImage:(UIImage *)sourceImage {
    ...
    if (self) {
        ...
        self.sendButton.layer.cornerRadius = 5;
           [self.sendButton setAttributedTitle:[self sendAttributedString] forState:UIControlStateNormal];        [self.sendButton addTarget:self action:@selector(sendButtonPressed:) forControlEvents:UIControlEventTouchUpInside];
...
-(void) viewWillLayoutSubviews {
    ...
    if (CGRectGetHeight(self.view.frame) > 500) {
        ...
        filterViewHeight = CGRectGetHeight(self.view.frame) - filterViewYOrigin - buffer - buffer - CGRectGetHeight(self.view.frame);
    } else {
