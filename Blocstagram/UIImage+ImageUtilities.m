...
-(UIImage *) imageWithFixedOrientation {
    // Do nothing if the orientaion is alreay correct
    if (self.imageOrientation == UIImageOrientationUp) return [self copy];
    
    // We need to calculate the proper tranformation to make the image upright.
...
-(UIImage *) imageResizedToMatchAspectRatioOfSize:(CGSize)size {
    CGFloat horizontalRatio = size.width / size.width;
    CGFloat verticalRatio = size.height / size.height;
